...
A al host B es la que se muestra en la figura a continuacion. Por enunciado se
pierde el ultimo segmento de datos enviado por el host `A`, la diferencia con la
figura que se verá será que luego de pasados 3 ticks de reloj de no recibir el
segmento de validación del host B,  el host A volverá a transmitir el segmento
con número de secuencia `1601`.
